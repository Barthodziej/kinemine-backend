...
public class AllMoviesHandler implements HttpHandler {

    MovieRepository repo;

    public AllMoviesHandler(MovieRepository repo) {
        this.repo = repo;
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        String response = listSerializer.serialize(repo.getAllMovies());
